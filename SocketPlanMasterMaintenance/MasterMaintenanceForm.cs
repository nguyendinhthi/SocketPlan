...
namespace SocketPlanMasterMaintenance
{
    ...
    public partial class MasterMaintenanceForm : Form
    {
        private int patternId;

        public MasterMaintenanceForm()
        {
            InitializeComponent();
        ...
        private void addEquipmentButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                detail.EquipmentName = EquipmentSelectionDialog.SelectedEquipment.Name;
                details.Add(detail);
        ...
        private Comment ConvertToComment(HRD.CHOPPER.WinUI.UnitWiringServiceReference.Comment uiComment)
        {

...
namespace SocketPlan.WebService
{
    ...
    [Serializable()]
    [DbTable(Name="SekisanMaterialDetails", DatabaseType=DatabaseType.SqlServer, ConnectionSettingKeyName="SocketPlan.WebService.Properties.Settings.ConnectionString")]
    public partial class SekisanMaterialDetail : DataEntity<SekisanMaterialDetail>
    {
        ...
        public static SekisanMaterialDetail Get(string _ConstructionCode, string _PlanNo, string _ShiyoushoNo, int _ConstructionItemType, string _ConstructionItemCode, int _ConstructionItemNo, string _ItemCode, int _SeqNo)
        {

...
namespace SocketPlan.WebService
{
    ...
    [Serializable()]
    [DbTable(Name="HouseTypeGroupDetails_Old", DatabaseType=DatabaseType.SqlServer, ConnectionSettingKeyName="SocketPlan.WebService.Properties.Settings.ConnectionString")]
    public partial class HouseTypeGroupDetails_Old : DataEntity<HouseTypeGroupDetails_Old>
    {
        ...
        public static HouseTypeGroupDetails_Old Get(string _ConstructionTypeCode)
        {
            HouseTypeGroupDetails_Old entity = new HouseTypeGroupDetails_Old();
